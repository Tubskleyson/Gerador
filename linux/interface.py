...
class App:
    ...
    def __init__(self):
        ...
        img = tkinter.Image("photo", file="assets/cert.png")
    ...
    def geraUm(self):
        ...
        input_file = os.path.abspath(self.pasta + i[0] + '.docx')
        output_file = os.path.abspath(self.pasta)


        self.doc.save(input_file)



        p1 = Popen(["soffice", "--headless", "--convert-to", "pdf", input_file, "--outdir", output_file], stdout=PIPE)
        p1.communicate()
